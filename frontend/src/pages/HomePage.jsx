...
const categories = [
	{ href: "/jeans", name: "Jeans", imageUrl: "/SnJeans.webp" },
	{ href: "/t-shirts", name: "T-shirts", imageUrl: "/SnTshirt.jpg" },
	{ href: "/shoes", name: "Shoes", imageUrl: "/shoes.webp" },
	{ href: "/glasses", name: "Glasses", imageUrl: "/glasses.webp" },
	{ href: "/jackets", name: "Jackets", imageUrl: "/SnJackets.jpg" },
      ...
      <div className='relative min-h-screen text-white overflow-hidden'>
			<div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2'>
				...
				<p className='text-center text-xl text-gray-300 mb-12'>
					Look good. Feel good. Do good — shop our latest trends
				</p>
